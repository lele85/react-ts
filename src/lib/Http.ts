...
function get<TResponse, TParams extends FetchParams> (uriPlaceholder: string, allParams:TParams, abortToken: AbortTokens) : Promise<HttpResponse<TResponse>> {
    ...
    return Axios.get(uri, {...params, cancelToken:request.token}).then((res) => {
