...
export function createFetchReducer<TParams, TResponse, TError> (INITIAL_STATE: FetchApiState<TResponse>, fetch:AsyncActionCreators<TParams, TResponse, TError>, fetchClear:ActionCreator<any>) {
